...
# ไม่แก้ odoo_service.py เพราะดีอยู่แล้ว แก้แค่ flex_messages.py

flex_messages = '''NO_IMAGE_URL = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/330px-No-Image-Placeholder.svg.png"
    ...
    if quotation:
        ...
        footer_contents = [
            ...
            {"type": "button", "style": "secondary",
             "action": {"type": "message", "label": "\\U0001f5d1\\ufe0f ล้างตะกร้า",
                        "text": "ล้างตะกร้า"}},
        ]
...
with open("app/templates/flex_messages.py", "w", encoding="utf-8") as f:
    f.write(flex_messages)
print("flex_messages.py created")
