content = '''NO_IMAGE_URL = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/330px-No-Image-Placeholder.svg.png"
...
with open("app/templates/flex_messages.py", "w", encoding="utf-8") as f:
    f.write(content)
print("flex_messages.py written successfully")