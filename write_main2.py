...
# Keywords ที่ตรวจสอบก่อน Claude
CLEAR_CART_KEYWORDS = ["ล้างตะกร้า", "เคลียร์ตะกร้า", "clear cart", "ลบทั้งหมด"]
VIEW_CART_KEYWORDS = ["ดูตะกร้า", "ตะกร้า", "รายการสินค้า", "cart", "สิ่งที่สั่ง"]
CONFIRM_KEYWORDS = ["ยืนยันสั่งซื้อ", "ยืนยัน", "confirm", "สั่งซื้อ"]
